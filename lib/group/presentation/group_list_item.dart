...
class GroupListItem extends StatelessWidget {
  ...
  Widget _buildGroupImage() {
    if (group.imageUrl == null) {
      return Container(
        color: AppColorStyles.gray60.withOpacity(0.5),
        child: const Center(
  ...
  Widget _buildImageErrorWidget() {
    return Container(
      color: AppColorStyles.gray60.withOpacity(0.5),
      child: const Center(
        child: Icon(Icons.broken_image_rounded, size: 30, color: Colors.white),
      ),
    );
  }
      ...
      children: [
        ...group.hashTags
            ...
            .map(
              (tag) => Text(
                '#${tag.content}',
                style: AppTextStyles.captionRegular.copyWith(color: textColor),
              ),
            ),
