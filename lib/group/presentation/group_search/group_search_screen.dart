...
class GroupSearchScreen extends StatefulWidget {
  final GroupSearchState state;
  final void Function(GroupSearchAction action) onAction;
...
class _GroupSearchScreenState extends State<GroupSearchScreen> {
  ...
  @override
  void didUpdateWidget(GroupSearchScreen oldWidget) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () => widget.onAction(const GroupSearchAction.onGoBack()),
              ...
              child: TextField(
                ...
                onSubmitted: (value) {
                  if (value.trim().isNotEmpty) {
                    widget.onAction(GroupSearchAction.onSearch(value));
                  }
                },
              ),
            ),
            ...
            AnimatedOpacity(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  widget.onAction(const GroupSearchAction.onClearSearch());
                },
              ),
            ),
              ...
              child: InkWell(
                ...
                onTap: () {
                  if (_searchController.text.trim().isNotEmpty) {
                    widget.onAction(
                      GroupSearchAction.onSearch(_searchController.text),
                    );
                  }
                },
                child: const Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                onPressed:
                    () => widget.onAction(
                      const GroupSearchAction.onClearAllRecentSearches(),
                    ),
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return Material(
                ...
                child: InkWell(
                  onTap:
                      () => widget.onAction(GroupSearchAction.onSearch(query)),
                  borderRadius: BorderRadius.circular(20),
                  child: Container(
                    padding: const EdgeInsets.symmetric(
                      horizontal: 12,
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: InkResponse(
                            onTap:
                                () => widget.onAction(
                                  GroupSearchAction.onRemoveRecentSearch(query),
                                ),
                            radius: 12,
                            child: const Icon(
                              Icons.close,
