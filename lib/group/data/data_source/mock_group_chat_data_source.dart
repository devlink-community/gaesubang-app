...
class MockGroupChatDataSource implements GroupChatDataSource {
  ...
  final List<Map<String, String>> _mockUsers = [
    {'id': 'user1', 'name': '사용자1', 'image': 'https://randomuser.me/api/portraits/men/1.jpg'},
    {'id': 'user2', 'name': '사용자2', 'image': 'https://randomuser.me/api/portraits/women/2.jpg'},
    {'id': 'user3', 'name': '사용자3', 'image': 'https://randomuser.me/api/portraits/men/3.jpg'},
    {'id': 'user4', 'name': '사용자4', 'image': 'https://randomuser.me/api/portraits/women/4.jpg'},
  ];
  ...
  // 스트림 컨트롤러 생성 또는 가져오기
  StreamController<List<Map<String, dynamic>>> _getStreamController(String groupId) {
    if (!_streamControllers.containsKey(groupId) || _streamControllers[groupId]!.isClosed) {
      _streamControllers[groupId] = StreamController<List<Map<String, dynamic>>>.broadcast();
    }
