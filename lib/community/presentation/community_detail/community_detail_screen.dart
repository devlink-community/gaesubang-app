  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: widget.state.post.when(
        ...
        data:
            (post) => RefreshIndicator(
              onRefresh:
                  () async => widget.onAction(
              ...
              child: ListView(
                ...
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '${widget.state.comments.value?.length ?? 0}',
                              ),
                  ...
                  widget.state.comments.when(
                    ...
                    error:
                        (e, _) => const Center(child: Text('댓글을 불러올 수 없습니다')),
                    data:
                        (comments) => ListView.separated(
                          ...
                          itemBuilder:
                              (_, i) => CommentItem(comment: comments[i]),
                        ),
                  ),
