...
import '../domain/usecase/get_user_groups_use_case.dart';
...
@riverpod
GetUserGroupsUseCase getUserGroupsUseCase(Ref ref) =>
    GetUserGroupsUseCase(repository: ref.watch(homeRepositoryProvider));
