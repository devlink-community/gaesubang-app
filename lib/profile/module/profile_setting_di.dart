...
import '../data/repository_impl/profile_setting_repository_impl.dart';
...
part 'profile_setting_di.g.dart';

// Repository Provider
@riverpod
ProfileSettingRepository profileSettingRepository(Ref ref) {
...
GetCurrentProfileUseCase getCurrentProfileUseCase(Ref ref) {
  return GetCurrentProfileUseCase(ref.watch(profileSettingRepositoryProvider));
}

@riverpod
UpdateProfileUseCase updateProfileUseCase(Ref ref) {
  return UpdateProfileUseCase(ref.watch(profileSettingRepositoryProvider));
}

@riverpod
UpdateProfileImageUseCase updateProfileImageUseCase(Ref ref) {
  return UpdateProfileImageUseCase(ref.watch(profileSettingRepositoryProvider));
}
